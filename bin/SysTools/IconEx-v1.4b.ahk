/* ²éÕÒÍ¼±ê
   ...
   _____                ______          __  _       _
  |_   _|              |  ____|        /_ || |  _  | |         SKAN ( Suresh Kumar A N )
    | |  ___ ___  _ __ | |__  __  __    | || |_| | | |__       arian.suresh@gmail.com
    | | / __/ _ \| '_ \|  __| \ \/ /    | ||___| | | '_ \
   _| || (_| (_) | | | | |____ >  <     | |    | | | |_) |     Created on    : 13-May-2008
  |_____\___\___/|_| |_|______/_/\_\    |_|(_) |_| |_.__/      Last Modified : 01-Jul-2010

 [ I C O N  E X P L O R E R  A N D  E X T R A C T O R ]        Version : 1.4b
   _______________________________________________________________________________________
*/
...
EnumResNameProc( hModule, lpszType, lpszName, lParam ) { 
 ...
 If DllCall( "msvcrt\_msize", UInt,lpszName )
...
Gui, Show, w655 h535 , IconEx - v1.3b
